...
public class FileUploadTests {
  ...
  public void tc1_shouldListAllFiles() throws Exception {
    ...
    this.mockMvc.perform(get("/listfiles")).andExpect(status().isOk()).andExpect(content().string(
  ...
  public void tc2_shouldSaveUploadedFile() throws Exception {
    ...
    this.mockMvc.perform(multipart("/uploadfile").file(multipartFile)).andExpect(status().isOk())
